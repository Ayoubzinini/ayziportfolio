...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ayoub\Downloads\Django-first-portfolio\djenv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ayoub\Downloads\Django-first-portfolio\djenv\Scripts\deactivate.nu'
